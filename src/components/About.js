...
function About() {
  return (
    <div>
      ...
      <p>
        Polite, real Mark here. I made Hollywood Hangman because I wanted to
        create a fun game with a lot of replayability. I built it using React,
        ...
        on October 5, 2020. Those IDs were then used to get the actual movie
        data using{" "}
        <a
